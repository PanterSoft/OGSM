...
<ul>
    ...
    <li class="right"><a class="active" href="contact.php"><i class="far fa-address-book"></i> Kontakt</a></li>
...
<div class="row">
    ...
    <div class="column middle">
        <h1>Kontakt</h1>
        <br>
        <h4><p style="text-align: center"><strong>So erreicht Ihr uns:</strong></p></h4>

            <br>
                <p>GitHub: www.github/ökjasrglhbglih/.de</p>
                <p>Website: www.ödkrjgneir.de</p>
                <p>E-mail: jabflaww@kjanrfpi.de</p>
